...
public class Erode extends Contract{
    ...
    public void onEnemyCauseDamage(PlayerJoinEvent e){
        if (selectedIndex>=0){
            ...
            e.getPlayer().getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue(20*(1-ratio));
        }
    }
    ...
    public void onStart(){
        ...
        for(Player player:getServer().getOnlinePlayers()){
            player.getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue(20*(1-ratio));
